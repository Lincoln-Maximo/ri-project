...
COMMENT ON DATABASE real_intelligence_db
    IS 'Banco de dados do sistema Real Intelligence — detecção de EPIs por câmera';
...
VALUES (
    'Administrador Real Intelligence',
    'admin@realintelligence.com.br',
    '$2b$12$u9NOU0bEOLOKUvlmRT0YvOjz3qD61RfL5XMtBgPN.HZR55LEGBPPy',
    'admin'
...
INSERT INTO tipos_violacao (nome, descricao, nivel_perigo, cor_badge)
VALUES
    ('Sem Capacete', 'Pessoa detectada sem usar capacete de segurança', 'alto',  '#FF5252'),
    ('Com Capacete', 'Pessoa detectada usando capacete de segurança',   'baixo', '#4CAF50')
ON CONFLICT (nome) DO NOTHING;
